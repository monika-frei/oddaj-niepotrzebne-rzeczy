  ...
  render() {
    ...
    if (this.props.user.email === "") {
      ...
      nav = (
        <>
          <li onClick={this.handleMenuClose}>
            <NavLink to="/oddaj-rzeczy" className="btn__auth">
              Oddaj rzeczy
            </NavLink>
          </li>
          <li onClick={this.handleMenuClose}>
            <NavLink to="/" className="btn__auth">
      ...
      <section className="mobile__header" id="mobileHeader">
        <div className="mobile__menu">
          ...
          <div className={this.state.navClass}>
            <ul>
              <li onClick={this.handleMenuClose}>
                <Link activeClass="active" smooth to="/#homeStart">
                  Start
                </Link>
              </li>
              <li onClick={this.handleMenuClose}>
                <Link activeClass="active" smooth to="/#homeHow">
                  O co chodzi?
                </Link>
              </li>
              <li onClick={this.handleMenuClose}>
                <Link activeClass="active" smooth to="/#homeAboutUs">
                  O nas
                </Link>
              </li>
              <li onClick={this.handleMenuClose}>
                <Link activeClass="active" smooth to="/#homeFundOrg">
                  Fundacje i organizacje
                </Link>
              </li>
              <li onClick={this.handleMenuClose}>
                <Link activeClass="active" smooth to="/#homeContact">
                  Kontakt
                </Link>
              </li>
              {nav}
